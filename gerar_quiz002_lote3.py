"""
gerar_quiz002_lote3.py — NEXOR FractalQuiz · Lote 3 (7 domínios finais)

Uso:
    python gerar_quiz002_lote3.py
    python gerar_quiz002_lote3.py --dry-run
"""
...
LOG_FILE = Path(r"C:\ARAGORN\aragorn_quiz\quiz002_lote3_log.txt")
...
DOMAINS = [
    {"key": "expert_witness",       "name": "Expert Witness in Fraud Cases"},
    {"key": "evidence_principles",  "name": "Basic Principles of Evidence"},
    {"key": "ethics_fraud_examiners","name": "Ethics for Fraud Examiners"},
    {"key": "criminal_prosecutions","name": "Criminal Prosecutions"},
    {"key": "data_analysis_tools",  "name": "Data Analysis Tools in Fraud Examination"},
    {"key": "data_theft_ip",        "name": "Theft of Data & Intellectual Property"},
    {"key": "corruption_bribery",   "name": "Corruption & Bribery Schemes"},
]
...
def main():
    ...
    log("=" * 64)
    log(f"NEXOR · FractalQuiz · Lote 3 (FINAL) · 7 domínios · {'DRY-RUN' if args.dry_run else 'EXECUTANDO'}")
    log("=" * 64)
