...
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d2_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d2_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d2_quiz002.txt"
...
def main():
    log("=" * 60)
    log(f"NEXOR MED — Quiz 002 — {DOMAIN_NAME} — PT")
