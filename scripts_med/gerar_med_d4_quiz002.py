...
SUBDOMINIO   = "perioperatorio"
DOMAIN_NAME  = "D4 · Perioperatório"
CERT_NAME    = "Residência Médica — Cirurgia Geral"
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d4_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d4_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d4_quiz002.txt"
...
TOPICOS = [
    "Avaliação pré-operatória e risco cirúrgico — classificação ASA",
    "Medicações que devem ser suspensas no pré-operatório",
    "Jejum pré-operatório — diretrizes atuais",
    "Antibioticoterapia profilática — indicações e timing",
    "Resposta metabólica ao trauma e cirurgia (REMIT)",
    "Complicações pós-operatórias — pulmonares, tromboembólicas, infecciosas",
    "Infecção de sítio cirúrgico — classificação e prevenção",
    "Nutrição perioperatória — indicações e vias"
]
...
Responda SOMENTE com JSON válido, sem markdown, sem backticks."""
    ...
    prompt = f"""Gere exatamente {n} questões nível {difficulty} ({camada} — {descricao}) sobre Perioperatório em Cirurgia Geral.
