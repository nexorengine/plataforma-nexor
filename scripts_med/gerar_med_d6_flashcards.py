...
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\flashcards\med\cirurgia_geral\flashcards_d6_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d6_flashcards.txt"
...
def gerar_camada(client, camada_codigo, camada_descricao, topicos):
    prompt = f"""Gere exatamente 12 flashcards de nível {camada_codigo} ({camada_descricao}) sobre Trato Digestivo Superior em Cirurgia Geral para prova de residência médica.
