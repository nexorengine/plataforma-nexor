...
SUBDOMINIO   = "trato_digestivo_inferior_coloproctologia"
DOMAIN_NAME  = "D7 · Trato Digestivo Inferior e Coloproctologia"
CERT_NAME    = "Residência Médica — Cirurgia Geral"
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d7_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d7_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d7_quiz002.txt"
...
TOPICOS = [
    "Câncer colorretal — estadiamento TNM e conduta",
    "Doença diverticular do cólon — classificação de Hinchey",
    "Hemorragia digestiva baixa — diagnóstico diferencial e conduta",
    "Doença hemorroidária — classificação e tratamento",
    "Fissura anal — aguda vs crônica e tratamento",
    "Fístula anal — classificação de Parks",
    "Doença inflamatória intestinal — Crohn vs retocolite ulcerativa",
    "Vólvulo de sigmóide e ceco"
]
...
Responda SOMENTE com JSON válido, sem markdown, sem backticks."""
    ...
    prompt = f"""Gere exatamente {n} questões nível {difficulty} ({camada} — {descricao}) sobre Trato Digestivo Inferior e Coloproctologia.
