...
SUBDOMINIO   = "cirurgia_vascular"
DOMAIN_NAME  = "D8 · Cirurgia Vascular"
CERT_NAME    = "Residência Médica — Cirurgia Geral"
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d8_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d8_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d8_quiz002.txt"
...
TOPICOS = [
    "TVP — diagnóstico, critérios de Wells e tratamento",
    "Embolia pulmonar — estratificação de risco e conduta",
    "Isquemia arterial aguda — 6 Ps e conduta",
    "Doença arterial periférica — claudicação e isquemia crítica",
    "Aneurisma de aorta abdominal — indicação cirúrgica e complicações",
    "Varizes dos membros inferiores — classificação CEAP",
    "Síndrome compartimental — diagnóstico e fasciotomia",
    "Acesso vascular e complicações"
]
...
Responda SOMENTE com JSON válido, sem markdown, sem backticks."""
    ...
    prompt = f"""Gere exatamente {n} questões nível {difficulty} ({camada} — {descricao}) sobre Cirurgia Vascular.
