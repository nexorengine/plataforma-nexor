...
SUBDOMINIO   = "hernias_parede_abdominal"
DOMAIN_NAME  = "D5 · Parede Abdominal e Hérnias"
CERT_NAME    = "Residência Médica — Cirurgia Geral"
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d5_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d5_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d5_quiz002.txt"
...
TOPICOS = [
    "Hérnia inguinal direta e indireta — classificação de Nyhus",
    "Hérnia femoral — diagnóstico e tratamento",
    "Hérnia umbilical — adulto e criança",
    "Hérnia incisional e ventral",
    "Hérnias complicadas — encarceramento e estrangulamento",
    "Técnicas de herniorrafia — Lichtenstein, Bassini, laparoscópica",
    "Anatomia da região inguinal — triângulo de Hasselbach",
    "Hérnia de Spiegel, lombar e obturatória"
]
...
Responda SOMENTE com JSON válido, sem markdown, sem backticks."""
    ...
    prompt = f"""Gere exatamente {n} questões nível {difficulty} ({camada} — {descricao}) sobre Parede Abdominal e Hérnias em Cirurgia Geral.
