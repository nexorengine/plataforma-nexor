...
QUIZ_NUM     = 2
LANG         = "pt"
QUIZ001_PATH = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d9_001_pt.json"
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\quizzes\med\cirurgia_geral\quiz_d9_002_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d9_quiz002.txt"
...
Responda SOMENTE com JSON válido, sem markdown, sem backticks."""
    ...
    prompt = f"""Gere exatamente {n} questões nível {difficulty} ({camada} — {descricao}) sobre Queimaduras em Cirurgia Geral.
