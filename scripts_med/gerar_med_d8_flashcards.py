...
OUTPUT_PATH  = r"C:\ARAGORN\aragorn_quiz\static\flashcards\med\cirurgia_geral\flashcards_d8_pt.json"
LOG_PATH     = r"C:\ARAGORN\aragorn_quiz\scripts_med\log_d8_flashcards.txt"
...
TOPICOS = [
    ...
    "Acesso vascular e complicações — cateter, fístula arteriovenosa"
]
...
def gerar_camada(client, camada_codigo, camada_descricao, topicos):
    prompt = f"""Gere exatamente 12 flashcards de nível {camada_codigo} ({camada_descricao}) sobre Cirurgia Vascular para prova de residência médica.
